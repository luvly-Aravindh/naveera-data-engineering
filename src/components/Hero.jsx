...
const METRICS = [
  ...
  { value: 11, suffix: " wks", label: "To Production (Avg.)" },
  { value: 200, suffix: "+", label: "CTOs Deployed" },
...
function DashPanel() {
  ...
  const stats = [
    { l:'Pipelines',     v:'42',    badge:'Healthy',     good:true  },
    { l:'P95 Latency',   v:'89ms',  badge:'Optimized',   good:false },
    { l:'Daily Records', v:'18M',   badge:'Streaming',   good:true  },
    { l:'Data Quality',  v:'99.6%', badge:'Verified',    good:true  },
  ]
  return (
    <div className="relative w-full max-w-[440px]"
      ...
      <div className="flex items-center gap-2 mb-5">
        ...
        <span className="f-mono text-[10px] text-white/30 ml-auto">data-ops · prod</span>
      </div>
  ...
  >
    ...
    >
      ...
      <span className="f-display text-[14px] font-bold leading-snug text-yellow/90 tracking-[0.08em] uppercase sm:text-[13px] lg:text-[15px]">
        Attention: US Tech Leaders, Your Data Infrastructure Is Failing Quietly
      </span>
    </div>
  </motion.div>
</div>
...
<div className="grid lg:grid-cols-2 gap-4 sm:gap-8 xl:gap-4 items-start">
  ...
  <div className="w-full">
    ...
    >
      Your data is scattered across systems. Pipelines fail under load, reports
      arrive late, and every new initiative kicks off with "we need to fix this
      first."
    </motion.p>
    ...
    >
      ...
      >
        <p className="f-display text-[9px] font-bold text-white/45 tracking-[0.18em] uppercase">
          Trusted By US Companies Building Data Systems That Run In Production
        </p>
      </div>
    </motion.div>
  </div>
