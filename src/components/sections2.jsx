...
═══════════════════════════════════════════════════════════ */
const STEPS = [
  { n:'01', icon:Target,     title:'Tech Strategy Call',          body:'You talk directly with a senior data engineer, not a sales rep. We review your current architecture, your pipeline failures, and where the last vendor left gaps.' },
  { n:'02', icon:FileText,   title:'Scoped Proposal',             body:'We send a fixed-scope proposal within five business days. Specific deliverables, a realistic timeline, and a defined cost range. No vague roadmaps.' },
  ...
  { n:'04', icon:Shield,     title:'Stabilization & Deployment',  body:'We run pipelines under load, fix what breaks, document the system, and deploy to your environment. Full IP transfer, supported by the same team that built it.' },
]
    ...
    <section id="process" className="sp" style={{ background:'#F8FAFC' }}>
      <div className="cx">
        <Reveal className="sh mb-16">
          <SH chip="How It Works" h2="How Naveera Tech Works" accent="for Your Data Infrastructure" />
        </Reveal>
...
const BADGES = [
  {
    name: "GoodFirms",
    image: goodFirms,
    desc: "Listed for Data Engineering & Production Pipeline Capabilities",
  },
  {
    name: "RightFirms",
    image: rightFirms,
    desc: "Featured Among US Data Engineering Firms",
  },
  {
    name: "SelectedFirms",
    image: selectedFirms,
    desc: "Recognized in Modern Data Stack & Warehouse Services",
  },
];
...
const ROWS = [
  {
    cap: 'Pipeline reliability under scale',
    other: 'Holds until data volume increases',
    nav: 'Built for real production load from day one',
  },
  {
    cap: 'Data ownership across systems',
    other: 'Split across multiple vendors and tools',
    nav: 'One team, full accountability end-to-end',
  },
  {
    cap: 'Pipeline failures in production',
    other: 'Breaks discovered after the fact',
    nav: 'Observability built in, failures caught early',
  },
  {
    cap: 'Architecture consistency',
    other: 'Disconnected tools, no unified data layer',
    nav: 'Built as one coherent, documented system',
  },
  {
    cap: 'Delivery timelines',
    other: 'Delays from coordination gaps between vendors',
    nav: 'Milestone-based, predictable execution',
  },
  {
    cap: 'IP ownership and control',
    other: 'Risk of tool lock-in and proprietary dependencies',
    nav: '100% owned by your team',
  },
]
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="text-center max-w-4xl mx-auto mb-16">
      ...
      <h2 className="mt-6 text-4xl md:text-6xl font-bold tracking-tight text-navy">
        Why Leading US Teams
        <span className="block text-orange">Choose Naveera Tech</span>
      </h2>

      <p className="mt-6 text-lg text-body leading-relaxed">
        Stop managing fragmented vendors and patching broken pipelines.
        Work with one team that builds, stabilizes, and owns your data infrastructure end-to-end.
      </p>
    </div>
    ...
    <div className="space-y-4">
      {[
        {
          title: 'Pipeline reliability under scale',
          other: 'Holds until data volume increases',
          nav: 'Built for real production load from day one',
        },
        {
          title: 'Data ownership across systems',
          other: 'Split across multiple vendors and tools',
          nav: 'One team, full accountability end-to-end',
        },
        {
          title: 'Pipeline failures in production',
          other: 'Breaks discovered after the fact',
          nav: 'Observability built in, failures caught early',
        },
        {
      ...
      <div className="inline-block rounded-3xl bg-navy px-4 sm:px-8 py-10 shadow-2xl max-w-3xl">
        <h3 className="text-2xl md:text-3xl font-bold text-white">
          ...
          <span className="block text-yellow">
            Start Shipping Reliable Data Systems On Time.
          </span>
        </h3>
...
═══════════════════════════════════════════════════════════ */
const FAQS = [
  { q:'Is this right for us right now?',                                                a:'If unreliable data is already slowing decisions, breaking reports, or impacting customers, this is for you. If you are still exploring or experimenting, you likely do not need this yet.' },
  { q:'Can you fix our current pipelines, or will this turn into a rebuild?',           a:'We start by stabilizing what exists. If your foundation cannot support scale, we will show you exactly where it fails and what a rebuild solves, before moving forward.' },
  { q:'How quickly will we see impact?',                                                a:'You will start seeing stability, faster pipelines, and more reliable outputs within weeks, not months. We focus on fixing what is breaking first.' },
  { q:'What makes this different from other vendors or internal attempts?',             a:'Most teams keep patching symptoms. We fix the core data architecture, so the same issues do not keep coming back every quarter.' },
  { q:'Will this slow down our current roadmap?',                                       a:'No. The goal is the opposite: to remove the bottlenecks that are already delaying your roadmap and help your team move faster with confidence.' },
  { q:'Do we need to hire or allocate internal resources?',                             a:'No heavy lift on your side. We plug into your existing setup, handle execution, and keep your team focused on priorities.' },
  { q:'What is the next step if we are serious about fixing this?',                     a:'We assess your current data stack, identify where it is breaking or lagging, and give you a clear, execution-ready plan to fix it, fast.' },
]
...
const LIVE = [
  ...
  { text:'Pipeline rebuild stabilized in production', time:'11m ago', c:'#010C44' },
  { text:'Client saved $340K replacing 3 vendors',    time:'28m ago', c:'#FEC800' },
  { text:'Warehouse migration completed today',       time:'1h ago',  c:'#EE6B00' },
]
        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-center">
          <motion.div ref={ref} initial={{ opacity:0, x:-40 }} animate={inView?{opacity:1,x:0}:{}}
            ...
            <h2 className="f-display font-black text-white mb-5 leading-[0.97]"
              ...
              Ready to Ship Reliable<br />
              <span className="text-grad-brand">Data Systems?</span>
            </h2>
...
>
    {/* <LoadingBar /> */}
            ...
            <div className="flex flex-wrap gap-7">
              {[['GoodFirms','★★★★★','Data Engineering'],['RightFirms','★★★★★','US Data Firms'],['SelectedFirms','★★★★★','Modern Data Stack']].map(([n,r,d])=>(
            ...
            <motion.div initial={{ opacity:0, y:16 }} animate={inView?{opacity:1,y:0}:{}}
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="f-body text-xs text-white/45 leading-relaxed">One team. One contract. Pipelines, warehouse, integration, and observability all under your IP.</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
...
═══════════════════════════════════════════════════════════ */
const COLS = [
  { title:'Services', links:['Data Pipelines','Data Warehouse','Legacy Migration','ETL/ELT Rebuilds','Observability','Data Mesh & Lakehouse'] },
        ...
        <div className="cx py-10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
            <div>
              ...
              <p className="f-body text-sm text-white/40">Data engineering insights, weekly.</p>
            </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <p className="f-body text-sm text-white/38 leading-relaxed mb-5 max-w-xs">
              High-performance data pipelines from broken to production. Trusted by 200+ US engineering teams.
            </p>
