    ...
    document.getElementById("contact")?.scrollIntoView({
      ...
      <div className="text-center max-w-2xl">
        <p className="f-display font-bold text-white text-lg sm:text-xl mb-2 leading-snug">
          Move From Broken Pipelines To Data Systems That Actually Run
        </p>

        <p className="f-body text-sm text-white/70">
          See how 200+ US tech teams fixed their data infrastructure and
          stopped shipping broken reports
        </p>
      </div>
    </div>
  </div>
