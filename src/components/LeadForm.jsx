...
const API_URL = "https://getnos.io/naveera-data-engineering/"
const THANK_YOU_URL = "https://getnos.io/naveera-data-engineering/index.php"
        ...
        <div className="text-center">
          ...
          <h2 className="f-display font-extrabold t-h2 mb-4 text-navy">
            ...
            <span className="text-grad-brand">
              of What's Failing In Your Data Stack
            </span>
          </h2>

          <p className="t-lead max-w-2xl mx-auto text-body">
            In 30 minutes, our data engineering team will review your current
            architecture, identify the root cause of your pipeline failures,
            and give you a specific remediation recommendation. No sales pitch
            just a direct technical assessment from someone who has shipped
            production data systems before.
          </p>
        </div>
      </div>
          ...
          {step === "form" && (
            <form onSubmit={sendOtp}>
              <div className="grid sm:grid-cols-2 gap-5 mb-5">
                ...
                <div className="sm:col-span-2">
                  <label className="field-label">
                    What's your biggest data infrastructure challenge right now?
